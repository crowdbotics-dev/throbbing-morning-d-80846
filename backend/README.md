...
## Project Structure
    ...
    ├── throbbing_morning_d_80846  # Django project configurations
...
1. Clone this repo and `cd throbbing_morning_d_80846`
...
2. Clone this repo and `cd throbbing_morning_d_80846`
